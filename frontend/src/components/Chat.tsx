...
export default function ChatApp() {
  ...
  return (
    <>
      ...
      <div className="lg:w-1/2 w-3/4 mx-auto p-5 border-2 border-zinc-300 bg-white rounded-md">
        <div className="rounded-md h-60 overflow-y-auto" ref={chatContainerRef}>
          {chat.map((msg, index) => (
            <div key={index}
            className="mb-1.5"
            >
              ...
              <div
                className={`text-zinc-400 text-xs ml-14
              flex ${
                msg.id === socket.current.id ? "justify-end" : "justify-start"
              }
              `}
